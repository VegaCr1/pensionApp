...
class Editar_pension extends StatefulWidget {
  // ignore: use_super_parameters
  const Editar_pension({Key? key}) : super(key: key);

  @override
  State<Editar_pension> createState() => Editar_estudianteState_();
}

// ignore: camel_case_types
class Editar_estudianteState_ extends State<Editar_pension> {
